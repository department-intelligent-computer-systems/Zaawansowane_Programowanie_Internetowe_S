...
return (
    ...
    <div>
        {!isFirstImage&&<button onClick={handlePrevClick}>Lewo</button>}
        {!isLastImage&&<button onClick={handleNextClick}> Prawo</button>}
    </div>
    </div>
);
};
function GalleryShow2(){
    return(
        <div className="App">
